...
def Hausdorff_dist(poly_a,poly_b):
    ...
    for i in range(len(poly_a)): # a poligonunun her bir köşesinden
        ...
        mesafe_listesi.append(minimum_mesafe) # a Poligonunun bir köşe noktasının b poligonundaki en yakın köşe noktasının arasındaki mesafe listeye eklenir
    hausdorff = np.max(mesafe_listesi) # En küçük uzaklıklar arasındaki en büyük değer Hausdorff mesafesi olur
    return hausdorff
# ------------------------------------------------------------------------------------------------
